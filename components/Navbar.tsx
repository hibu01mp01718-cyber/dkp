      ...
      <nav className={styles.navbar}>
        ...
        <div className={styles.userSection}>
          {user ? (
            ...
            <Button asChild variant="secondary" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <a href="/api/auth/signin/discord" aria-label="Login with Discord" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
