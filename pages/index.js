    ...
    <Layout>
      {!session ? (
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-2 sm:px-4 md:px-8">
          <h1 className="text-3xl sm:text-4xl font-bold mb-6 text-center">DKP Tracker</h1>
          <button
            className="flex items-center gap-2 bg-accent hover:bg-[#5865F2] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl shadow-lg font-semibold text-base sm:text-lg transition mb-2 w-full max-w-xs justify-center"
          ...
          <p className="text-muted text-center">You must log in with Discord to use DKP Tracker.</p>
        </div>
      ) : (
