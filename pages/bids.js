...
function BidFormInline({ item, bids, characters, user, onBidPlaced }) {
  ...
  style={{ minWidth: '80px', maxWidth: '100px', textAlign: 'center', fontWeight: 500, fontSize: '0.75rem', padding: '0.3rem 0.45rem' }}
      ...
      {ended && (
        <span className="text-xs text-red-400 ml-2">Bidding ended</span>
      )}
      {!ended && !canBid && (
          ...
          <table className="w-full rounded-xl overflow-hidden">
            <thead>
              <tr className="bg-[#181a20] text-white">
                <th className="py-2 text-center font-semibold" style={{paddingLeft: 0, paddingRight: 0}}>Name</th>
                <th className="py-2 text-center font-semibold" style={{paddingLeft: 0, paddingRight: 0}}>Description</th>
                <th className="py-2 text-center font-semibold" style={{paddingLeft: 0, paddingRight: 0}}>Time Left</th>
                <th className="py-2 text-center font-semibold" style={{paddingLeft: 0, paddingRight: 0}}>Highest Bid</th>
                <th className="py-2 text-center font-semibold" style={{paddingLeft: 0, paddingRight: 0}}>Min Bid</th>
                <th className="py-2 text-center font-semibold" style={{paddingLeft: 0, paddingRight: 0}}>Increment</th>
                <th className="py-2 text-center font-semibold" style={{paddingLeft: 0, paddingRight: 0}}>Winner</th>
                <th className="py-2 text-center font-semibold" style={{paddingLeft: 0, paddingRight: 0}}>Bid</th>
                {session?.user?.isAdmin && <th className="py-2 text-center font-semibold" style={{paddingLeft: 0, paddingRight: 0}}>Actions</th>}
              </tr>
            </thead>
            <tbody>
              {items.map((item) => (
